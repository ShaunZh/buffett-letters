...
tags_zh:
  ...
  - 公司治理
  - 收购
summary: 巴菲特 2002 年致股东信中英对照整理稿。本年度伯克希尔账面价值增长10.0%，浮存金大幅增加且成本降至1%，讨论了衍生品的巨大风险、公司治理改革、通用再保险的重整以及多项收购。
draft: false
---
...
**ZH**
1. 如果审计师单独负责编制公司的财务报表，报表是否会在任何方面与管理层选择的方式不同？这个问题应涵盖重大和非重大差异。如果审计师会以不同方式行事，则应披露管理层的论点和审计师的回应。然后审计委员会应评估事实。
...
**ZH**
2. 如果审计师是一名投资者，他是否收到了——用通俗易懂的英语——了解公司报告期内财务业绩所必需的信息？
...
**ZH**
3. 公司是否遵循了如果审计师本人是CEO时会遵循的相同内部审计程序？如果不是，差异在哪里，为什么？
...
**ZH**
4. 审计师是否知晓任何行为——无论是会计还是运营行为——其目的和效果是将收入或费用从一个报告期转移到另一个报告期？
